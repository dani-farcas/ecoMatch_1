    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('sent', 'Gesendet'), ('processing', 'In Bearbeitung'), ('connected', 'Verbunden mit Anbieter')], default='sent', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('service', models.ManyToManyField(to='core.servicetype')),
            ],
        ),
    ]
