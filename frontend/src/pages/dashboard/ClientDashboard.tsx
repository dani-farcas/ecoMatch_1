...
import { FaSun, FaMoon, FaUserCircle, FaSignOutAlt, FaUserEdit } from 'react-icons/fa';
...
const ClientDashboard: React.FC = () => {
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* 💬 Begrüßung und Info */}
      <h1 style={{ marginTop: '100px', fontSize: '1.8rem' }}>Willkommen im Kunden-Dashboard</h1>
